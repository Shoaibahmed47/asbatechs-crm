...
export function AppBreadcrumbs() {
  ...
  return (
    <nav className="mb-6" aria-label="Breadcrumb">
      <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200/90 bg-gradient-to-r from-white/90 via-white/75 to-slate-50/40 px-4 py-3 shadow-[0_8px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl dark:border-slate-700/90 dark:from-slate-950/80 dark:via-slate-950/70 dark:to-slate-900/40 dark:shadow-[0_8px_32px_rgba(0,0,0,0.35)]">
        <Link
          href="/dashboard"
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-slate-200/80 bg-white text-slate-600 shadow-sm transition hover:border-sky-300 hover:text-sky-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-sky-600 dark:hover:text-sky-400"
