...
const menuLinkClass =
  "flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2.5 text-base font-medium text-slate-900 no-underline outline-none transition-colors hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-slate-800";
      ...
      ? createPortal(
          ...
          >
            <div className="border-b border-slate-100 px-2.5 pb-2.5 pt-1 dark:border-slate-700">
              ...
              {me?.email ? (
                <div className="truncate text-sm text-slate-500 dark:text-slate-400">{me.email}</div>
              ) : null}
              {me ? (
  ...
  return (
    <div className="flex flex-col items-stretch gap-3 sm:items-end">
      ...
      <div className="hidden text-right sm:block">
        <div className="text-base font-semibold text-slate-950 dark:text-white">{me?.name ?? "Current user"}</div>
