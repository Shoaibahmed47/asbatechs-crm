  ...
  return (
    <div className="daily-focus-card relative overflow-hidden rounded-2xl border border-sky-200/60 bg-gradient-to-br from-white via-slate-50/90 to-sky-50/50 p-4 shadow-[0_0_28px_-4px_rgba(56,189,248,0.35),0_8px_24px_-8px_rgba(15,23,42,0.12)] dark:border-sky-500/25 dark:from-slate-900/90 dark:via-slate-900/80 dark:to-sky-950/40 dark:shadow-[0_0_32px_-6px_rgba(34,211,238,0.2),0_12px_28px_-10px_rgba(0,0,0,0.4)]">
      ...
      <div className="relative">
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-sky-700/90 dark:text-sky-300/95">
          Daily focus
        </div>
        <p className="daily-focus-animated-text mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">
          ...
          <span className="font-semibold text-cyan-700 dark:text-cyan-300">department</span> ownership
          current.
        </p>
      </div>
    </div>
