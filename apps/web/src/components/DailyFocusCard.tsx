...
export function DailyFocusCard() {
  return (
    <div className="daily-focus-card relative overflow-hidden rounded-2xl border border-brand-200/60 bg-gradient-to-br from-white via-slate-50/90 to-brand-50/50 p-4 shadow-[0_0_28px_-4px_color-mix(in srgb, var(--brand-teal-light) 35%, transparent),0_8px_24px_-8px_rgba(15,23,42,0.12)] dark:border-brand-500/25 dark:from-slate-900/90 dark:via-slate-900/80 dark:to-brand-950/40 dark:shadow-[0_0_32px_-6px_color-mix(in srgb, var(--brand-teal-lighter) 20%, transparent),0_12px_28px_-10px_rgba(0,0,0,0.4)] 2xl:p-5">
      <div
      ...
      <div className="relative">
        <div className="text-sm font-semibold uppercase tracking-[0.14em] text-brand-700/90 dark:text-brand-300/95">
          Daily focus
        </div>
